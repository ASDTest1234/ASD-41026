...
public class CartService {
    ...
    /**
     * Converts a MongoDB document to a Cart object.
     */
    ...
    /**
     * Updates the quantity of a product in the cart for a specific customer.
     */
    ...
    /**
     * Adds a product to the cart. If the cart does not exist, it creates a new cart.
     */
    public void addToCart(String customerId, String productId, int quantity) {
        ...
        Optional<Cart.CartItem> existingItem = cart.getItems().stream()
                .filter(item -> productId.equals(item.getProductId())) // 匹配 productId
                .findFirst();
        ...
        if (existingItem.isPresent()) {
            ...
            if (productOpt.isPresent()) {
                ...
                newItem.setProductId(product.getProduct_Id()); // 设置 productId
